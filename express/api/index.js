...
const logRequest = (req) => {
    ...
    console.log("Request Received", {
        ...
        url: req.originalUrl,
        headers: req.headers,
        // body: JSON.parse(JSON.stringify(req.body, (key, value) =>
        //     value && typeof value === "object" ? JSON.parse(JSON.stringify(value)) : value, 2))
...
const logResponse = (req, resBody) => {
    console.log("Response Sent", {
        url: req.originalUrl,
        // responseBody: JSON.parse(JSON.stringify(resBody, (key, value) =>
        //     value && typeof value === "object" ? JSON.parse(JSON.stringify(value)) : value, 2))
